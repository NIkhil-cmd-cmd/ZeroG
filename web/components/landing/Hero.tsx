...
import AntigravityEnterpriseBadge from "@/components/ui/AntigravityEnterpriseBadge";
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 md:pt-24">
          <div className="max-w-3xl">
            <h1 className="mb-6">
              <AntigravityEnterpriseBadge size="lg" />
            </h1>
            <p className="text-xl text-text-secondary leading-relaxed md:text-2xl">
              The shared memory layer for enterprise agent teams. One agent learns. Every
          ...
          <div className="mt-16 grid gap-4 md:grid-cols-3">
            {[
              ...
              { label: "Integration", value: "SKILL.md" },
            ].map((s) => (
